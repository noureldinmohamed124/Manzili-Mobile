          ...
          SoftCard(
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  const Text('تأسيس كهرباء', style: TextStyle(fontWeight: FontWeight.w800, fontSize: 20)),
                  const SizedBox(height: 8),
                  const Text('بواسطة: أحمد (ID: 104)'),
                  const SizedBox(height: 16),
                  const Text('الوصف', style: TextStyle(fontWeight: FontWeight.w800, fontSize: 16)),
                  const SizedBox(height: 8),
                  const Text(
                    'تأسيس شبكة الكهرباء بالكامل للشقق والمحلات بأسلاك معتمدة مع ضمان سنة.',
                    style: TextStyle(color: AppColors.textSecondary, height: 1.5),
                  ),
                  const Divider(height: 32),
                  const Text('بيانات إضافية', style: TextStyle(fontWeight: FontWeight.w800, fontSize: 16)),
                  const SizedBox(height: 12),
                  _buildRow('السعر', 'يبدأ من 500 جنيه'),
                  _buildRow('القسم', 'صيانة منزلية / كهرباء'),
