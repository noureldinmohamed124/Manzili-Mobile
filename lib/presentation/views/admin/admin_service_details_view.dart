...
class AdminServiceDetailsView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Column(
        children: [
          GradientAppBar(title: 'تفاصيل الخدمة #$serviceId'),
          Expanded(
                    ...
                    SoftCard(
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            Text(service.title, style: const TextStyle(fontWeight: FontWeight.w800, fontSize: 20)),
                            ...
                            const SizedBox(height: 8),
                            const Text('لا يتوفر وصف إضافي من الإدارة حالياً', style: TextStyle(color: AppColors.textSecondary, height: 1.5)),
    ...
    return Padding(
      ...
      child: Row(
        ...
        children: [
          ...
          const SizedBox(width: 12),
          Flexible(child: Text(value, style: const TextStyle(fontWeight: FontWeight.w600, overflow: TextOverflow.ellipsis), softWrap: true, textAlign: TextAlign.end)),
        ],
      ),
    );
  }
