...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    try {
      flutterEngine.getPlugins().add(new com.theextremity.cache_network_media.CacheNetworkMediaPlugin());
    } catch (Exception e) {
      Log.e(TAG, "Error registering plugin cache_network_media, com.theextremity.cache_network_media.CacheNetworkMediaPlugin", e);
    }
    try {
